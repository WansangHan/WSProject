...
enum RecvPacketType
{
	...
	RC_SUCCESS_IOCP_CONNECT,
	RC_SUCCESS_IOCP_UDP,
	RC_EXIT_PLAYER,
	RC_PLAYER_POSITION_SCALE,
	RC_AIOBJECT_POSITION_SCALE,
	// EPOLL -> CLIENT
	RC_SUCCESS_EPOLL_CONNECT = 60000,
	RC_SUCCESS_EPOLL_UDP,
};

enum SendPacketType
{
	// CLIENT -> IOCP
	SD_ENTER_IOCP_SERVER = 10000,
	SD_APPLY_IOCP_UDP_SOCKET,
	SD_POSITION_SCALE,
	// CLIENT -> EPOLL
	SD_ENTER_EPOLL_SERVER = 50000,
	SD_APPLY_EPOLL_UDP_SOCKET,
};
